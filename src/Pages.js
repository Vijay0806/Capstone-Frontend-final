...
const TabsComp = ({ toggle, setToggle }) => {
  ...
  <span class="whitespace-nowrap text-sm text-red-500 mt-2">𝕋𝕣𝕠𝕡𝕚𝕔𝕒𝕝</span>
</div>
        ...
        <span class="whitespace-nowrap text-sm text-red-500 mt-2">ℕ𝕒𝕥𝕚𝕠𝕟𝕒𝕝ℙ𝕒𝕣𝕜𝕤 </span>
      </div>
        ...
        <span class="whitespace-nowrap text-sm text-red-500 mt-2">𝔸𝕞𝕒𝕫𝕚𝕟𝕘 ℙ𝕠𝕠𝕝𝕤</span>
      </div>
          ...
          <Tab className='tabImg md:pr-1 pr-0'>
            <div className='w-8'>
              ...
              <span class="whitespace-nowrap text-sm text-red-500 mt-2">𝔹𝕖𝕒𝕔𝕙𝕖𝕤</span>
            </div>
          ...
          <Tab className='tabImg md:pr-1 pr-0'>
            <div className='w-8'>
              ...
              <span class="whitespace-nowrap text-sm text-red-500 mt-2">𝕋𝕚𝕟𝕪ℍ𝕠𝕞𝕖𝕤</span>
            </div>
          ...
          <Tab className='tabImg md:pr-1 pr-0'>
            <div className='w-8'>
              ...
              <span class="whitespace-nowrap text-sm text-red-500 mt-2">𝔻𝕖𝕤𝕚𝕘𝕟</span>
            </div>
          ...
          <Tab className='tabImg md:pr-1 pr-0'>
            <div className='w-8'>
              ...
              <span class="whitespace-nowrap text-sm text-red-500 mt-2">𝕀𝕤𝕝𝕒𝕟𝕕𝕤</span>
            </div>
          ...
          <Tab className='tabImg md:pr-1 pr-0'>
            <div className='w-8'>
              ...
              <span class="whitespace-nowrap text-sm text-red-500 mt-2">𝕍𝕚𝕖𝕨</span>
            </div>
          ...
          <Tab className='tabImg md:pr-1 pr-0'>
            <div className='w-8'>
              ...
              <span class="whitespace-nowrap text-sm text-red-500 mt-2">ℂ𝕠𝕦𝕡𝕝𝕖</span>
            </div>
          ...
          <Tab className='tabImg md:pr-1 pr-0'>
            <div className='w-8'>
              ...
              <span class="whitespace-nowrap text-sm text-red-500 mt-2">𝔸𝕣𝕔𝕥𝕚𝕔 </span>
            </div>
