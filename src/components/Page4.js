                            ...
                            <div className='card boxsh' key={item.id}>
                                ...
                                <Link to={`/${item.id}`}>
                                    ...
                                    <div className='flex justify-center pl-2 gap-4 md:gap-3'>
                                        ...
                                        <span className='flex items-center'> <FaBed className=' md:text-2xl text-xl mr-2' /> <p className='text-sm text-gray-400 w-16'>{Math.floor(Math.random() * 5) + 1} Beds </p></span>
